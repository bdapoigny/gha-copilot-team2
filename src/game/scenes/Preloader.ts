...
export class Preloader extends Scene
{
    ...
    init ()
    {
        ...
        //  Betclic-branded progress bar with red color
        this.add.rectangle(512, 384, 468, 32).setStrokeStyle(1, 0xE81E2B);

        //  This is the progress bar itself. It will increase in size from the left based on the % of progress.
        const bar = this.add.rectangle(512-230, 384, 4, 28, 0xE81E2B);
